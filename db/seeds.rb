...
Flat.create!(
  name: 'St Michaels Hill Hotel',
  address: 'Liverpool Road Birmingham N12 4DS',
  picture_url: 'https://source.unsplash.com/random',
  description: 'A masive room within in Hotel at StMichaels Hill, with its own en garage and workshop.',
  price_per_night: 55,
  number_of_guests: 1
)
